                    ...
                    <x-slot name="inputs">
                        ...
                        <div class="col-lg-12">
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <x-admin.v1.form.text-input errorName="" prepend="" value="{{$role->name}}" size="col-md-6"
                                                                name="name"
                                ...
                                <x-slot name="options">
                                    @foreach($permissions as $permission)
                                        <x-admin.v1.form.checkbox-input
                                            ...
                                            checked="{{$role->hasPermissionTo($permission->name) ? 1: 0}}"
                                            name="permissions[]"
                                            value="{{$permission->name}}"
                                            title="{{__('labels.'.$permission->name)}}"/>
                                    @endforeach
                                </x-slot>
