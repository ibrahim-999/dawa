...
<div id="modal-{{$id}}" {{ $attributes->merge(['class' => 'modal fade '.$classes]) }} tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-right" style="justify-content: flex-start; width: 50%">
        <div class="modal-content" >
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <button class="btn btn-outline-primary" onclick="$('#form-{{$id}}').submit()">{{__('labels.create')}}</button>
                </div>
