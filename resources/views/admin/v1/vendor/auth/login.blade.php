<x-login-page-lite pageTitle="{{__('pages_title.vendor_login')}}" baseUrl="{{route('dashboard')}}"
                   logo="{{asset('admin-panel-assets/v1/images/logo-dark.png')}}" url="{{route('admin.login.post')}}">
    <x-slot name="page_description">{{__('vendor_text.login_page_lite')}}</x-slot>
    <x-slot name="inputs">
