...
@section('content')
    <x-admin.v1.layout.partials.basic-page-header>
        <x-slot name="breadcrumbs">
            <x-admin.v1.layout.partials.bread-crumb-item title="{{__('labels.dashboard')}}" url="{{route('dashboard')}}"
                                                         isActive="0"/>
            <x-admin.v1.layout.partials.bread-crumb-item title="{{__('labels.coupon_index')}}" url="" isActive="1"/>
        </x-slot>
        <x-slot name="title">
    ...
    <x-admin.v1.table.table>
        ...
        <x-slot name="rows">
            @include('admin.v1.coupon.partials.rows')
        </x-slot>
