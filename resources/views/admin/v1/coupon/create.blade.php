...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card" >
            <div class="card-body">
                <x-admin.v1.form.form title="{{__('forms.add_coupon_title')}}"
                                      description="{{__('forms.add_coupon_description')}}"
                                      url="{{route('coupons.store')}}"
                                      method="POST" fileable="false">
                    <x-slot name="inputs">
                        <div class="row">
                            <x-admin.v1.form.text-input errorName="" prepend="" value="{{old('code')}}" size="col-md-6" name="code"
                        ...
                        <div class="row">
                            <x-admin.v1.form.number-input step="0.1"  min="0.1" max="50000" errorName="" value="{{old('discount')}}" prepend="" size="col-md-12" name="discount"
                            title="{{__('labels.discount')}}"
                            placeholder="{{__('placeholders.discount')}}"/>

                            <x-admin.v1.form.number-input step="0.1"  min="0.1" max="50000" errorName="" value="{{old('min_purchases')}}" prepend="" size="col-md-12" name="min_purchases"
                            title="{{__('labels.min_purchases')}}"
                            placeholder="{{__('placeholders.min_purchases')}}"/>

                            <x-admin.v1.form.number-input step="0.1"  min="0.1" max="50000" errorName="" value="{{old('max_discount')}}" prepend="" size="col-md-12" name="max_discount"
                            title="{{__('labels.max_discount')}}"
                            placeholder="{{__('placeholders.max_discount')}}"/>
                        </div>
                        <div class="row">
                            <x-admin.v1.form.number-input step="0.1"  min="0.1" max="50000" errorName="" value="{{old('num_uses_person')}}" prepend="" size="col-md-6" name="num_uses_person"
                            title="{{__('labels.num_uses_person')}}"
                            placeholder="{{__('placeholders.num_uses_person')}}"/>
                            <x-admin.v1.form.number-input step="0.1"  min="0.1" max="50000" errorName="" value="{{old('num_uses')}}" prepend="" size="col-md-6" name="num_uses"
                        ...
                        <div class="row">
                            ...
                            <x-slot name="options">                           
                                ...
                                <option @if(old('categories') && in_array($category->id,old('categories'))) selected
                        ...
                        <x-slot name="options">                           
                            ...
                            <option @if(old('products') && in_array($product->id,old('products'))) selected
