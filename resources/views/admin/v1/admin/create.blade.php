...
@section('content')
    <x-admin.v1.layout.partials.basic-page-header>
        <x-slot name="breadcrumbs">
            ...
            <x-admin.v1.layout.partials.bread-crumb-item title="{{__('labels.admins_create')}}" url="" isActive="1"/>
        </x-slot>
        <x-slot name="title">
    ...
    <div class="col-lg-12">
        <div class="card" >
            <div class="card-body">
                <x-admin.v1.form.form title="{{__('forms.add_admin_title')}}"
                                      description="{{__('forms.add_admin_description')}}"
