...
@section('title',__('pages_title.show_product')."|".$product->title)
@section('content')
    <x-admin.v1.layout.partials.basic-page-header>
        <x-slot name="breadcrumbs">
            ...
            <x-admin.v1.layout.partials.bread-crumb-item title="{{$product->title}}" url=""
                                                         isActive="1"/>
        </x-slot>
        <x-slot name="title">
        ...
        <div class="row">
            <div class="col-sm-6 col-xl-3">
                <div class="p-2 text-center">
                    ...
                    <h3><span data-plugin="counterup">{{$variants->count()}}</span></h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <!-- end card-box-->
            @include('admin.v1.product.partials.product_data')
            @include('admin.v1.product.partials.product_charts')

        </div>
        <div class="col-lg-8">
            @include('admin.v1.product.partials.attributes_table')
            @include('admin.v1.product.partials.variants_table')
