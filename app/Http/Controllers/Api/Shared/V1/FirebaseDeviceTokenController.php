...
class FirebaseDeviceTokenController extends ApiController
{
     ...
     */
    public function store(StoreFirebaseDeviceTokenRequest $request)
    {
        $token = $this->firebaseDeviceTokenService->add($request);
